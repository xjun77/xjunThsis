  ...
  <div class="chat-box">
    ...
    <div class="msg-box" ref="msg-box">
      <div
        ...
        :key="index"
        class="msg"
        :style="i.username == user.username?'flex-direction:row-reverse':''"
      >
        <div style="font-size: 10px;color:#8a98ad;margin: 0 5px;">
          {{i.username}}
          <br />
          <span style="line-height: 30px;">{{i.time}}</span>
        </div>
        <div class="user-head">
        ...
        <div class="user-msg">
          <span
            :style="i.username == user.username?' float: right;':''"
            :class="i.username == user.username?'right':'left'"
          >{{i.content}}</span>
        </div>
      </div>
    </div>
